...
self.DailyGathererAchievements.push(element)})})};self.findDailyAchievements=function(){var dailyIds=[];$.get("https://api.guildwars2.com/v2/achievements/daily",function(data){data.pve.forEach(function(element){dailyIds.push(element.id)});self.findAchievementInfo(dailyIds)})}
